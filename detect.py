...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints/yolov3_drone.pth", help="path to weights file")
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        if detections is not None:
            ...
            bbox_colors = ["c", "m", "r", "k", "y", "g", "b"]
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                #print((x1,y1), (x2,y2))
                if opt.plot and int(cls_pred)==2:
